            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredAssignments?.map((assignment) => {
                    ...
                    return (
                        <div
                            key={assignment._id}
                            className="group cursor-pointer rounded-2xl p-6 bg-slate-200 border-t border-l border-white shadow-[8px_12px_20px_rgba(0,0,0,0.1),inset_-2px_-2px_6px_rgba(0,0,0,0.05),inset_2px_2px_6px_rgba(255,255,255,0.7)] hover:-translate-y-1 hover:shadow-[12px_16px_25px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col justify-between"
                            onClick={() =>
                        ...
                        >
                            <div>
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    >
                                        <button
                                            className="p-2 rounded-lg bg-yellow-100/80 text-yellow-700 shadow-[inset_1px_1px_2px_rgba(255,255,255,0.8),0_2px_3px_rgba(0,0,0,0.1)] border border-yellow-300 hover:bg-yellow-200 active:translate-y-[1px] transition-all"
                                            onClick={() =>
                                                navigate(
                                                    `/assignments/edit/${assignment._id}`
                                                )
                                            }
                                        >
                                        ...
                                        <button
                                            className="p-2 rounded-lg bg-red-100/80 text-red-700 shadow-[inset_1px_1px_2px_rgba(255,255,255,0.8),0_2px_3px_rgba(0,0,0,0.1)] border border-red-300 hover:bg-red-200 active:translate-y-[1px] transition-all"
                                        >
