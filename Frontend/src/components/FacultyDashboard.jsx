        ...
        <div className="space-y-10">
            ...
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Your teaching dashboard is ready.</p>
                </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 rounded-3xl p-8 bg-linear-to-br from-indigo-500/20 to-cyan-500/10 border border-white/10">
                    <p className="uppercase text-xs tracking-widest text-slate-400">Current Class</p>
                    <h2 className="text-2xl font-bold mt-3">Database Systems Lecture</h2>
                    <p className="text-slate-400">Room 301 • 10:00 AM - 11:30 AM</p>
                </div>
